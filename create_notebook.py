#!/usr/bin/env python3
"""
Script to convert Python analysis scripts to Jupyter notebook format
"""

import json

def create_simple_notebook():
    """Create the simple analysis notebook"""
...
print("="*80)'''
    ...
    # Save the notebook
    with open('Chapter4_Simple_Analysis.ipynb', 'w') as f:
        json.dump(notebook, f, indent=1)

    print('Created Jupyter notebook: Chapter4_Simple_Analysis.ipynb')
